...
#define FUN_AREP LT(_FUN, QK_AREP)
#define MAC TO(_MAC)
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |  ____  |   F  |   P  |   D  |LSft L|   X  |                              |   ;  |RSft U|   O  |   Y  |   B  |   Z    |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |  ____  |LCtl S|LAlt N|LGui T| Sym H|   K  |                              |   ,  | Sym A|RGui E|RAlt I|RCtl C|   Q    |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |  ____  |   V  |   W  |   G  |   M  |   J  | ____ |Adjust|  | Lock | ____ |   -  |   .  |   '  |   =  |  DE  |  ____  |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | ____ | ____ | Fun  | Num  | ____ |  | ____ | Nav  | Rep  | ____ | ____ |
 *                        |      |      | ARep | R    |      |  |      | Space|      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 * ,-----------------------------------.                                              ,-----------------------------------.
 ...
 */
    [_MAC] = LAYOUT_split_3x6_5_hlc(
     KC_NO   , KC_F    , KC_P    , KC_D    , LSFT_L  , KC_X    ,                                         KC_SCLN , RSFT_U  , KC_O    , KC_Y    , KC_B    , KC_Z    ,
     KC_NO   , HOME_S  , HOME_N  , HOME_T  , HOME_H  , KC_K    ,                                         KC_COMM , HOME_A  , HOME_E  , HOME_I  , HOME_C  , KC_Q    ,
     KC_NO   , KC_V    , KC_W    , KC_G    , KC_M    , KC_J    , KC_NO   , ADJUST  , M_LOCK  , KC_NO   , KC_MINS , KC_DOT  , KC_QUOT , KC_EQL  , M_DE    , KC_NO   ,
                                   KC_NO   , KC_NO   , FUN_AREP, NUM_R   , KC_NO   , KC_NO   , NAV_SPC , QK_REP  , KC_NO   , KC_NO   ,
 ...
 */
    [_LW] = LAYOUT_split_3x6_5_hlc(
     KC_NO   , KC_F    , KC_P    , KC_D    , LSFT_L  , KC_X    ,                                         KC_SCLN , RSFT_U  , KC_O    , KC_Y    , KC_B    , KC_Z    ,
     KC_NO   , HOME_S  , HOME_N  , HOME_T  , HOME_H  , KC_K    ,                                         KC_COMM , HOME_A  , HOME_E  , HOME_I  , HOME_C  , KC_Q    ,
     KC_NO   , KC_V    , KC_W    , KC_G    , KC_M    , KC_J    , KC_NO   , ADJUST  , LW_LOCK , KC_NO   , KC_MINS , KC_DOT  , KC_QUOT , KC_EQL  , LW_DE   , KC_NO   ,
                                   KC_NO   , KC_NO   , FUN_AREP, NUM_R   , KC_NO   , KC_NO   , NAV_SPC , QK_REP  , KC_NO   , KC_NO   ,
     KC_MUTE , KC_NO   , KC_NO   , KC_NO   , KC_NO   ,                                                             KC_MUTE , KC_NO   , KC_NO   , KC_NO   , KC_NO
    ),
 ...
 * |    ^   |   #  |   *  |   [  |   ]  |   &  |                              |   ;  |   <  |   >  |   @  |   ~  |    `   |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        |LCtl !|LAlt \|LGui (|   )  |   :  |                              |   ,  |   /  |RGui _|RAlt =|RCtl ?|  ____  |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |   %  |   $  |   {  |   }  |   |  |      |      |  |      |      |   -  |   .  |   '  |   "  |   +  |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 ...
 */
    [_SYM] = LAYOUT_split_3x6_5_hlc(
     ...
     _______ ,HOME_EXLM,HOME_BSLS,HOME_LPRN, KC_RPRN , KC_COLN ,                                         KC_COMM , KC_SLSH ,HOME_UNDS ,HOME_EQL,HOME_QUES, KC_NO   ,
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |  ____  | ____ | ____ | ____ | LSft | ____ |                              | ____ |  ⌫   |   ↑  |   ⌦  | ____ |  ____  |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        | LCtl | LAlt | LGui | ____ | ____ |                              | Tab  |  ←   |   ↓  |   →  | ____ |  ____  |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        | ____ | ____ | ____ | ____ | ____ |      |      |  |      |      | ____ |Enter | ____ | ____ | ____ |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      | Esc  | LLck |  |      |      |      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 ...
 */
    [_NAV] = LAYOUT_split_3x6_5_hlc(
     KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_LSFT , KC_NO   ,                                         KC_NO   , KC_BSPC , KC_UP   , KC_DEL  , KC_NO   , KC_NO   ,
     _______ , KC_LCTL , KC_LALT , KC_LGUI , KC_NO   , KC_NO   ,                                         KC_TAB  , KC_LEFT , KC_DOWN , KC_RGHT , KC_NO   , KC_NO   ,
     _______ , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , _______ , _______ , _______ , _______ , KC_NO   , KC_ENT  , KC_NO   , KC_NO   , KC_NO   , _______ ,
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |  ____  | ____ | ____ | ____ | LSft | ____ |                              |   /  |   4  |   5  |   6  |   +  |    *   |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        | LCtl | LAlt | LGui | ____ | ____ |                              |   :  |   1  |   2  |   3  |   -  |    =   |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 ...
 */
    [_NUM] = LAYOUT_split_3x6_5_hlc(
     KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_LSFT , KC_NO   ,                                         KC_PSLS , KC_P4   , KC_P5   , KC_P6   , KC_PPLS , KC_PAST ,
     _______ , KC_LCTL , KC_LALT , KC_LGUI , KC_NO   , KC_NO   ,                                         KC_COLN , KC_P1   , KC_P2   , KC_P3   , KC_PMNS , KC_PEQL ,
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |  ____  | ____ | ____ | ____ | LSft | ____ |                              | ____ |  F4  |  F5  |  F6  |  F10 |  ____  |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        | LCtl | LAlt | LGui | ____ | ____ |                              | ____ |  F1  |  F2  |  F3  |  F11 |  ____  |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 ...
 */
    [_FUN] = LAYOUT_split_3x6_5_hlc(
     _______ , KC_NO   , KC_NO   , KC_NO   , KC_LSFT , KC_NO   ,                                         KC_NO   , KC_F4   , KC_F5   , KC_F6   , KC_F10  , KC_NO   ,
     _______ , KC_LCTL , KC_LALT , KC_LGUI , KC_NO   , KC_NO   ,                                         KC_NO   , KC_F1   , KC_F2   , KC_F3   , KC_F11  , KC_NO   ,
 ...
 */
    [_M_DE] = LAYOUT_split_3x6_5_hlc(
     _______ , _______ , _______ , _______ , KC_LSFT , _______ ,                                         _______ , M_DE_UE , M_DE_OE , _______ , _______ , _______ ,
 ...
 */
    [_LW_DE] = LAYOUT_split_3x6_5_hlc(
     _______ , _______ , _______ , _______ , KC_LSFT , _______ ,                                         _______ ,LW_DE_UE ,LW_DE_OE , _______ , _______ , _______ ,
