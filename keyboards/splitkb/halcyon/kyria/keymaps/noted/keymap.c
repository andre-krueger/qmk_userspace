 ...
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |Sym/Tab |LCtl/C|LAlt/S|LGui/I|LSft/E|   O  |                              |   D  |RSft/T|RGui/N|RAlt/R|RCtl/H|  Sym   |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |CapsWord|   V  |   X  |   Ü  |   Ä  |   Ö  | ____ | ____ |  | Lock | ____ |   W  |   G  | ,  < | .  > |   K  |ARepeat |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | ____ |Adjust| Num/ | Fun  | ____ |  | ____ |Enter | Nav/ |Adjust| ____ |
 *                        |      |      | Space|      |      |  |      |      | Esc  |      |      |
 *                        `----------------------------------'  `----------------------------------'
 * ,-----------------------------------.                                              ,-----------------------------------.
 ...
 */
    [_MAC] = LAYOUT_split_3x6_5_hlc(
     ...
     SYM_TAB , HOME_C  , HOME_S  , HOME_I  , HOME_E  , KC_O    ,                                         KC_D    , HOME_T  , HOME_N  , HOME_R  , HOME_H  , SYM     ,
     CW_TOGG , KC_V    , KC_X    ,MAC_DE_UE,MAC_DE_AE,MAC_DE_OE, KC_NO   , KC_NO   ,MAC_LOCK , KC_NO   , KC_W    , KC_G    , KC_COMM , KC_DOT  , KC_K    , QK_AREP ,
                                   KC_NO   , ADJUST  , NUM_SPC , FUN     , KC_NO   , KC_NO   , KC_ENT  , NAV_ESC , ADJUST  , KC_NO   ,
 ...
 * |CapsWord|   V  |   X  |   Ü  |   Ä  |   Ö  | ____ | ____ |  | Lock | ____ |   W  |   G  | ,  < | .  > |   K  |ARepeat |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | ____ |Adjust| Num/ | Num  | ____ |  | ____ |Enter | Nav/ |Adjust| ____ |
 *                        |      |      | Space|      |      |  |      |      | Esc  |      |      |
 *                        `----------------------------------'  `----------------------------------'
 * ,-----------------------------------.                                              ,-----------------------------------.
 * | MUTE | ____ | _____ | ____ | ____ |                                              | MUTE | ____ | _____ | ____ | ____ |
 ...
 */
    [_LW] = LAYOUT_split_3x6_5_hlc(
     KC_J    , KC_Y    , KC_Z    , KC_U    , KC_A    , KC_Q    ,                                         KC_P    , KC_B    , KC_M    , KC_L    , KC_F    , DE_S    ,
     SYM_TAB , HOME_C  , HOME_S  , HOME_I  , HOME_E  , KC_O    ,                                         KC_D    , HOME_T  , HOME_N  , HOME_R  , HOME_H  , SYM     ,
     CW_TOGG , KC_V    , KC_X    ,LW_DE_UE ,LW_DE_AE ,LW_DE_OE , KC_NO   , KC_NO   , LW_LOCK , KC_NO   , KC_W    , KC_G    , KC_COMM , KC_DOT  , KC_K    , QK_AREP ,
                                   KC_NO   , ADJUST  , NUM_SPC , FUN     , KC_NO   , KC_NO   , KC_ENT  , NAV_ESC , ADJUST  , KC_NO   ,
     KC_MUTE , KC_NO   , KC_NO   , KC_NO   , KC_NO   ,                                                   KC_MUTE , KC_NO   , KC_NO   , KC_NO   , KC_NO
    ),
 ...
 */
    [_NAV] = LAYOUT_split_3x6_5_hlc(
     ...
     _______ , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , _______ , _______ , _______ , _______ , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , _______ ,
                                   _______ , _______ , KC_BSPC , KC_DEL  , _______ , _______ , _______ , _______ , _______ , _______ ,
     _______ , _______ , _______ , _______ , _______ ,                                                   _______ , _______ , _______ , _______ , _______
    ),
